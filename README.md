...
Créé par **AntoinePhD** (Antoine Sépulchre, antsep1617@gmail.com).

**Licence** : Ce projet est partagé en accès libre pour un usage personnel et non-commercial.

- Vous pouvez utiliser ce programme et le distribuer tel quel
- Vous devez citer l'auteur (AntoinePhD) et ce projet dans tout usage ou partage
- Les modifications et dérivés doivent être partagés dans les mêmes conditions (copyleft)
- À usage non-commercial uniquement

---

## Remerciements

- **Microsoft** pour les voix TTS Edge gratuites et accessibles
- La communauté open-source Python pour les bibliothèques utilisées
- Toute personne qui contribue à rendre la lecture accessible à tous
